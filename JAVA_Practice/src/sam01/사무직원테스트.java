...
//		System.out.println("학교명: " + 여자.학교명);	// 오류
		...
		사람 사람3 = 열심히일하는사무직원; //업캐스팅 (사무직원 → 사람)
//		System.out.println(사람3);	//sam01.사무직원@156643d4

		교직원 교직원3 = 열심히일하는사무직원; // 업캐스팅 (사무직원 → 사람)
		사무직원 사무1 = 열심히일하는사무직원;
		
		System.out.println("----------------");
		System.out.println("이름: " + 사람3.이름 + ", 주민번호: " + 사람3.번호);
		System.out.println("학교명: " + 교직원3.학교명 + ", 교원번호: " + 교직원3.번호);
//		System.out.println("부서명: " + 사람3.부서);		//	에러
//		System.out.println("부서명: " + 교직원3.부서);		//	에러
